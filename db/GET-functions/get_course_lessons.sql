...
$block$
BEGIN
  RAISE NOTICE '[SETUP]   (GET) FUNCTION: setting up the get_course_lessons function ...';

  CREATE OR REPLACE FUNCTION get_course_lessons (course_id_ BIGINT) RETURNS
  TABLE (
    lesson_id BIGINT,
    title VARCHAR,
  ...
  RAISE NOTICE '[SETUP]   (GET) FUNCTION: DONE setting up the get_course_lessons function.';
END
