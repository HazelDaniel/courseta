...
\echo 'attempting assessments';
INSERT INTO students__assessments (student_id, assessment_id, submitted_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_quiz_id_1', :'courseta_var_retake_time'::timestamp);

INSERT INTO students__assessments (student_id, assessment_id, submitted_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_exam_id_1', :'courseta_var_retake_time'::timestamp);


\echo 'answering questions';
INSERT INTO students__questions (student_id, question_id, answered_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_question_id_1', :'courseta_var_retake_time'::timestamp);

INSERT INTO students__questions (student_id, question_id, answered_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_question_id_2', :'courseta_var_retake_time'::timestamp);



INSERT INTO students__questions (student_id, question_id, answered_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_question_id_3', :'courseta_var_retake_time'::timestamp);

INSERT INTO students__questions (student_id, question_id, answered_at)
VALUES (:'courseta_var_student_id_1', :'courseta_var_question_id_4', :'courseta_var_retake_time'::timestamp);
...
INSERT INTO students__answers (student_id, answer_id, question_id, selected_at)
VALUES
(:'courseta_var_student_id_1', :'courseta_var_answer_id_1', :'courseta_var_question_id_1', :'courseta_var_retake_time'::timestamp),
(:'courseta_var_student_id_1', :'courseta_var_answer_id_2', :'courseta_var_question_id_1', :'courseta_var_retake_time'::timestamp),
-- (:'courseta_var_student_id_1', :'courseta_var_answer_id_3', :'courseta_var_question_id_1', :'courseta_var_retake_time'::timestamp),
(:'courseta_var_student_id_1', :'courseta_var_answer_id_6', :'courseta_var_question_id_1', :'courseta_var_retake_time'::timestamp),

(:'courseta_var_student_id_1', :'courseta_var_answer_id_5', :'courseta_var_question_id_2', :'courseta_var_retake_time'::timestamp);


-- \echo 'selecting exam answers';
INSERT INTO students__answers (student_id, answer_id, question_id, selected_at)
VALUES
(:'courseta_var_student_id_1', :'courseta_var_answer_id_7', :'courseta_var_question_id_3', :'courseta_var_retake_time'::timestamp);
-- (:'courseta_var_student_id_1', :'courseta_var_answer_id_8', :'courseta_var_question_id_3', :'courseta_var_retake_time'::timestamp),
-- (:'courseta_var_student_id_1', :'courseta_var_answer_id_9', :'courseta_var_question_id_3', :'courseta_var_retake_time'::timestamp),

-- (:'courseta_var_student_id_1', :'courseta_var_answer_id_10', :'courseta_var_question_id_4', :'courseta_var_retake_time'::timestamp);
-- (:'courseta_var_student_id_1', :'courseta_var_answer_id_11', :'courseta_var_question_id_4', :'courseta_var_retake_time'::timestamp);
