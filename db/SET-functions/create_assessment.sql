...
BEGIN
  ...
  BEGIN
    ...
    ELSE
      ...
      (assessment_data->>'startDate')::TIMESTAMPTZ, (assessment_data->>'endDate')::TIMESTAMPTZ) RETURNING exam_id INTO created_assessment_id;
    END CASE;
  ...
  RAISE NOTICE '[SETUP]   (SET) FUNCTION: DONE setting up the SET function to create an assessment with its questions and answers included';
END;
