...
BEGIN
  ...
  CREATE OR REPLACE PROCEDURE remove_content_from_lesson (lesson_id_ BIGINT)
  LANGUAGE PLPGSQL AS
  $block1$
  BEGIN
    DELETE from courseta.lesson_contents WHERE lesson_contents.lesson_id = lesson_id_;
  END;
  $block1$;
