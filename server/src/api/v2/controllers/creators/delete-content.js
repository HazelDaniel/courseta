...
export const deleteContent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { lesson_id: lessonID, content_id: contentID, creator_id: creatorID, course_id: courseID, } = req.params;
