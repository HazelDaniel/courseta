...
export const unenrollCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { course_id: courseID } = req.params;
    const { user } = req;
    const unEnrollPayload = req.body;
    const { studentID } = unEnrollPayload;
    yield EnrollmentModel.delete(studentID, courseID);
