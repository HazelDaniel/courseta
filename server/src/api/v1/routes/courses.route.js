...
v1CoursesRouter.get("/", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1CoursesRouter.get("/:course_id/reviews", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1CoursesRouter.get("/:course_id/creator/summary", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
...
v1CoursesRouter.get("/:course_id/lessons", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
...
v1CoursesRouter.get("/:course_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
        ...
        const resPromises = yield Promise.all([resCoursePromise, studentEnrollmentStatus]);
...
v1CoursesRouter.get("/:course_id/exams/:exam_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1CoursesRouter.get("/:course_id/lessons/:lesson_id/quizzes/:quiz_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1CoursesRouter.get("/:course_id/lessons/:lesson_id/contents/:content_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1CoursesRouter.post("/:course_id/reviews", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
...
v1CoursesRouter.post("/:course_id/enroll", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
        const reviewPayload = req.body;
...
v1CoursesRouter.post("/:course_id/unenroll", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { course_id: courseID } = req.params;
        const { user } = req;
        const reviewPayload = req.body;
