...
v1AssessmentsRouter.get("/:assessment_id/questions", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1AssessmentsRouter.post("/:assessment_id/submit", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { assessment_id: assessmentID } = req.params;
        const { user } = req;
        if (!user.id)
