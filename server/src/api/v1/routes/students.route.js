...
v1StudentsRouter.post("/auth/signup", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1StudentsRouter.post("/auth/login", passport.authenticate("students_local"), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1StudentsRouter.get("/:student_id/courses", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
v1StudentsRouter.get("/:student_id/courses/recommended", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { student_id: studentID } = req.params;
...
v1StudentsRouter.get("/:student_id/courses/unfinished", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { student_id: studentID } = req.params;
...
v1StudentsRouter.get("/:student_id/reports", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { student_id: studentID } = req.params;
...
v1StudentsRouter.get("/:student_id/me", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
v1StudentsRouter.put("/:student_id/me", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { student_id: studentID } = req.params;
...
v1StudentsRouter.post("/:student_id/logout", studentIDProtected, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        req.logOut((err) => {
            if (err)
                return next(err);
